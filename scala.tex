...
\begin{itemize}
  ...
  \begin{itemize}
    \item weniger globale Zustände
    \item weniger Dinge können sich $\Delta$
...
\begin{itemize}
  ...
  \item \textbf{Listen sind homogen}\footnote{d.h. innerhalb einer Liste müssen
  ...
  \item \textbf{Listen mergen}:\texttt{:::}-Operator:
