...
\begin{itemize}
  ...
  Konstruktoren für die Klasse
    ...
    \lstinputlisting{beispiele/klassen_constructor.scala}
  ...
  \lstinputlisting{beispiele/call_by_name.scala}
  ...
  \lstinputlisting{beispiele/generators.scala}
  ...
  formale Parameter erwähnt wird
    ...
    \lstinputlisting{beispiele/unausgewertete_parameter_uebergabe.scala}
  ...
  \item Kommentare:
\lstinputlisting{beispiele/comments.scala}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/array.scala}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/refining_functions.scala}
\end{itemize}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/if_else_ternary_while.scala}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/for_easy.scala}
  
  \item verschachtelte Variante:
  
  \lstinputlisting{beispiele/for_middle.scala}
  
  \item in for-Schleifen kann man auch guards packen:
  
  \lstinputlisting{beispiele/for_guards.scala}
\end{itemize}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/throw_try_finally.scala}
  ...
  \begin{itemize}
    ...
    \lstinputlisting{beispiele/try_finally.scala}    
  \end{itemize}
\end{itemize}
...
\lstinputlisting{beispiele/enumeration.scala}


\subsection{Linearisierung der Objekthierarchie}
betrachte folgendes Bsp.:

\lstinputlisting{beispiele/linearization_object_hierarchiy.scala}
...
\lstinputlisting{beispiele/method_declaration_4.scala}
  ...
  \lstinputlisting{beispiele/method_declaration_6.scala}
...
\begin{itemize}
  \item   \lstinputlisting{beispiele/nested_functions.scala}
  ...
  \lstinputlisting{beispiele/parameter_passing_nested_functions.scala}  
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/comparison_call_by_value_call_by_name.scala}
...
Rückgabewert der Fkt.:
  ...
  \lstinputlisting{beispiele/typparameter_functions.scala}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/function_container.scala}  
\end{itemize}
...
Fkt. mit callback Fkt. haben folgende Syntax: 
  ...
  \lstinputlisting{beispiele/callback.scala}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/callback_anonymous.scala}
\end{itemize}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/partial_functions.scala}
  ...
  \lstinputlisting{beispiele/partial_notation.scala}
  
  
  durch diese Notation kann man Codeblöcke als Parameter übergeben:
  
  \lstinputlisting{beispiele/partial_codeblocks.scala}
  ...
  \lstinputlisting{beispiele/partial_functions_easy.scala}  

\end{itemize}


\subsection{Schwanzrekursion}
\lstinputlisting{beispiele/gcd.scala}


\lstinputlisting{beispiele/factorial.scala}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/nested_functions.scala}
\end{itemize}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/currying.scala}
  
  \item wir werden nun Funktionen, die Funktionen zurückgegeben,
  behandelt?
  
  \lstinputlisting{beispiele/currying_1.scala}
  ...
  \lstinputlisting{beispiele/currying_3.scala}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/fp_list_map.scala}
  
  \item anonyme Fkt. auch auf ein val drücken:
  
  \lstinputlisting{beispiele/fp_list_map_value.scala}
...
Gefahr eines Stackoverflows:
  ...
  \lstinputlisting{beispiele/factorial_recursive_and_tail_call.scala}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/lists_fp.scala}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/folding_reducing.scala}  
\end{itemize}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/curried_functions.scala}
...
\lstinputlisting{beispiele/lazy_vals.scala} 
\pagebreak
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/listen.scala}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/cons.scala}
  ...
  \lstinputlisting{beispiele/listen_1.scala}
  
  \item \textbf{Item an Liste dranhängen}:
  
  \lstinputlisting{beispiele/collection_append.scala}
  ...
  \lstinputlisting{beispiele/collection_mergen.scala}
  
  \item \textbf{typische Listen-Ops}:
  
  \lstinputlisting{beispiele/collection_ops.scala}
  
  \item \texttt{filter} funzt bei jeder Collection, welche einen
  bestimmten Typ enthält:
  
  \lstinputlisting{beispiele/collection_universel.scala}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/collection_foldLeft.scala}
  
  \item geschachtelten Collection erstellen:
  
  \lstinputlisting{beispiele/collection_nested.scala}
  ...
  \begin{itemize}
    ...
    \lstinputlisting{beispiele/for_comprehension.scala}
    
    \item genereller Aufbau von for-comprehension:
    
    \begin{shadowminipage}
    \lstinputlisting{beispiele/for_comprehension_generell.scala}
    \end{shadowminipage}
    ...
    \lstinputlisting{beispiele/collection_for_comprehesion.scala}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/tupel_example.scala}
  ...
  \lstinputlisting{beispiele/tupel_creation.scala}
  ...
  \lstinputlisting{beispiele/tupleator.scala}
\end{itemize}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/map_examples.scala}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/rational_numbers.scala}
  ...
  \lstinputlisting{beispiele/object_creation.scala}
  ...
  \lstinputlisting{beispiele/vererbung.scala}
  ...
  \lstinputlisting{beispiele/override.scala}
    
  \item \textbf{Abstrakte Klassen}: 
  
  \lstinputlisting{beispiele/abstrakte_klassen.scala}
  ...
  \lstinputlisting{beispiele/implementierung_einer_abstrakten_klasse.scala}
  ...
  \lstinputlisting{beispiele/traits.scala}
  ...
  \lstinputlisting{beispiele/object.scala}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/nested_classes.scala}
\end{itemize}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/import.scala}
  ...
  \lstinputlisting{beispiele/import_bracktes.scala}
  
  \item können alias für Imports definieren:
  
  \lstinputlisting{beispiele/import_alias.scala}
  
  \item man kann auch bestimmte Klassen vom import \enquote{excluden}
  
  \lstinputlisting{beispiele/import_exclude.scala}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/gencell.scala}
  ...
  \lstinputlisting{beispiele/gencell_swap.scala}
  
  \item Anwendung von swap:
  
  \lstinputlisting{beispiele/gencell_swap_usage.scala}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/apply.scala}
  ...
  \lstinputlisting{beispiele/unapply.scala}
\end{itemize}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/abstract_list_iterator.scala}
  ...
  \lstinputlisting{beispiele/iterators_for_mixin_class_composition.scala}
  ...
  \begin{itemize}
    ...
    \lstinputlisting{beispiele/mixin_class_composition.scala}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/algebraic_calculator.scala}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/algebraic_calculator_case.scala}
  \item nun folgt die Implementierung der \texttt{eval}-Funktion nach dem
  Pattern-Matching Prinzip:
  
  \lstinputlisting{beispiele/algebraic_calculator_pattern_matching.scala}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/match.scala}
  
  \item \textbf{Fibonaccizahlen} verschiedenen Varianten:
  
  \lstinputlisting{beispiele/pattern_matching_fibonacci.scala}
  
  \item \textbf{Matching Any Type}:
  
  \lstinputlisting{beispiele/matching_any_type.scala}
  ...
  \lstinputlisting{beispiele/pattern_datatypes.scala}
  
  \item \textbf{Case-Klassen} gehören auch zu dieser Klasse:
  
  \lstinputlisting{beispiele/pattern_matching_case_class.scala}
  
  \item \textbf{verschachteltes Pattern-Matching in case-Klassen}:
  
  \lstinputlisting{beispiele/pattern_matching_nested.scala}

  \item \textbf{Pattern-Matching Listen}:
  
  \lstinputlisting{beispiele/pattern_matching_lists.scala}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/trait_creation.scala}
...
\begin{itemize}
  ...
  \lstinputlisting{beispiele/covariant_parameter_types.scala}
\end{itemize}
